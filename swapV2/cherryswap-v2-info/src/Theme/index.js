...
const theme = (darkMode, color) => ({
  ...
  // cherryswapPink: darkMode ? '#E55268' : 'black',
  cherryswapPink: darkMode ? 'red' : 'black',

  concreteGray: darkMode ? '#292C2F' : '#fffdfa',
  inputBackground: darkMode ? '#1F1F1F' : '#fffdfa',
  shadowColor: darkMode ? '#000' : '#E55268',
  ...
  //primary colors
  primary1: darkMode ? '#E55268' : '#E55268',
  primary2: darkMode ? '#E55268' : '#FF8CC3',
  primary3: darkMode ? '#E55268' : '#FF99C9',
  primary4: darkMode ? '#376bad70' : '#F6DDE8',
  primary5: darkMode ? '#153d6f70' : '#FDEAF1',

  // color text
  primaryText1: darkMode ? '#E55268' : '#E55268',

  // secondary colors
  secondary1: darkMode ? '#E55268' : '#E55268',
  secondary2: darkMode ? '#17000b26' : '#F6DDE8',
  secondary3: darkMode ? '#17000b26' : '#FDEAF1',

  shadow1: darkMode ? '#000' : '#E55268',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #E55268 30 0%, #fff 0%)`,
})
