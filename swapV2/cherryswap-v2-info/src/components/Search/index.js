...
import { useAllPairsInCherryswap, useAllTokensInCherryswap } from '../../contexts/GlobalData'
...
export const Search = ({ small = false }) => {
  let allTokens = useAllTokensInCherryswap()
  const allTokenData = useAllTokenData()

  let allPairs = useAllPairsInCherryswap()
        ...
        <Input
          ...
          placeholder={
            small
              ...
              : 'Search CherrySwap pairs and tokens...'
          }
          value={value}
          onChange={(e) => {
