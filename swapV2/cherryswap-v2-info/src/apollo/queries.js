...
export const SUBGRAPH_HEALTH = gql`
  query health {
    indexingStatusForCurrentVersion(subgraphName: "cherryswap/subgraph") {
      synced
      health
      chains {
        chainHeadBlock {
...
/*
*
* createdAtBlockNumber_gte
* */
/*export const PAIRS_CURRENT = gql`
  query pairs {
    pairs(first: 100, where: { createdAtBlockNumber_gte : 1235308},  orderBy: trackedReserveETH, orderDirection: desc) {
      id
    }
  }
`*/
