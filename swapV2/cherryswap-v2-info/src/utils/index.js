...
export function getPoolLink(token0Address, token1Address = null, remove = false) {
  if (!token1Address) {
    return (
      ...
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x2219845942d28716c0F7C605765fABDcA1a7d9E0' ? 'ETH' : token0Address}/${'ETH'}`
    )
  } else {
    return (
      `https://www.cherryswap.net/#/` +
      (remove ? `remove` : `add`) +
      `/${token0Address === '0x2219845942d28716c0F7C605765fABDcA1a7d9E0' ? 'ETH' : token0Address}/${
        token1Address === '0x2219845942d28716c0F7C605765fABDcA1a7d9E0' ? 'ETH' : token1Address
      }`
    )
  }
}
...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://www.cherryswap.net/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://www.cherryswap.net/#/swap?inputCurrency=${
      token0Address === '0x2219845942d28716c0F7C605765fABDcA1a7d9E0' ? 'ETH' : token0Address
    }&outputCurrency=${token1Address === '0x2219845942d28716c0F7C605765fABDcA1a7d9E0' ? 'ETH' : token1Address}`
  }
}


export function getCherryswapAppLink(linkVariable) {
  let baseCherryswapUrl = 'https://www.cherryswap.net/#/uni'
  if (!linkVariable) {
    return baseCherryswapUrl
  }

  return `${baseCherryswapUrl}/ETH/${linkVariable}`
}
...
export const formatTime = (unix) => {
  // const now = dayjs.unix(1616465130)
  const now = dayjs()
...
export function formattedPercent(percent, useBrackets = false) {
  ...
  if (percent < 0.0001 && percent > 0) {
    return (
      <Text fontWeight={500} color="#50C895">
        {'< 0.0001%'}
      </Text>
    )
  }
  ...
  if (percent < 0 && percent > -0.0001) {
    return (
      <Text fontWeight={500} color="#EB94A1">
        {'< 0.0001%'}
      </Text>
    )
  }
  ...
  if (fixedPercent > 0) {
    if (fixedPercent > 100) {
      return <Text fontWeight={500} color="#50C895">{`+${percent?.toFixed(0).toLocaleString()}%`}</Text>
    } else {
      return <Text fontWeight={500} color="#50C895">{`+${fixedPercent}%`}</Text>
    }
  } else {
    return <Text fontWeight={500} color="#EB94A1">{`${fixedPercent}%`}</Text>
  }
}
